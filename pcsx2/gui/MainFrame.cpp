...
void MainEmuFrame::ConnectMenus()
{
	...
	Bind(wxEVT_MENU, &MainEmuFrame::Menu_Recording_VirtualPad_Open_Click, this, MenuId_Recording_VirtualPad_Port0_0, MenuId_Recording_VirtualPad_Port0_0 + 8);
#endif
}
...
void MainEmuFrame::CreateRecordMenu()
{
	...
	m_submenuvirtualPort0.Append(MenuId_Recording_VirtualPad_Port0_0, _("Virtual Pad (Port 1 - Slot A)"), _("Opens the controller window for the virtual pad mapped to slot 1A."));
	m_submenuvirtualPort0.Append(MenuId_Recording_VirtualPad_Port0_1, _("Virtual Pad (Port 1 - Slot B)"), _("Opens the controller window for the virtual pad mapped to slot 1B."));
	m_submenuvirtualPort0.Append(MenuId_Recording_VirtualPad_Port0_2, _("Virtual Pad (Port 1 - Slot C)"), _("Opens the controller window for the virtual pad mapped to slot 1C."));
	m_submenuvirtualPort0.Append(MenuId_Recording_VirtualPad_Port0_3, _("Virtual Pad (Port 1 - Slot D)"), _("Opens the controller window for the virtual pad mapped to slot 1D."));
	m_submenuvirtualPort1.Append(MenuId_Recording_VirtualPad_Port1_0, _("Virtual Pad (Port 2 - Slot A)"), _("Opens the controller window for the virtual pad mapped to slot 2A."));
	m_submenuvirtualPort1.Append(MenuId_Recording_VirtualPad_Port1_1, _("Virtual Pad (Port 2 - Slot B)"), _("Opens the controller window for the virtual pad mapped to slot 2B."));
	m_submenuvirtualPort1.Append(MenuId_Recording_VirtualPad_Port1_2, _("Virtual Pad (Port 2 - Slot C)"), _("Opens the controller window for the virtual pad mapped to slot 2C."));
	m_submenuvirtualPort1.Append(MenuId_Recording_VirtualPad_Port1_3, _("Virtual Pad (Port 2 - Slot D)"), _("Opens the controller window for the virtual pad mapped to slot 2D."));
#endif
}
...
void MainEmuFrame::ApplyConfigToGui(AppConfig& configToApply, int flags)
{
	...
	{ //these should not be affected by presets
		...
		if (!g_InputRecording.IsActive())
		{
			for (u8 pad = 0; pad < 3; pad++)
			{
				menubar.Enable(MenuId_Recording_VirtualPad_Port0_1 + pad, configToApply.EmuOptions.MultitapPort0_Enabled);
				menubar.Enable(MenuId_Recording_VirtualPad_Port1_1 + pad, configToApply.EmuOptions.MultitapPort1_Enabled);
			}
		}
#endif
